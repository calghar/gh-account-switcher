#!/usr/bin/env bash
# GitHub Account Switcher for macOS
# Easily switch between multiple GitHub accounts on macOS systems
...
show_help() {
    echo -e "${BLUE}GitHub Account Switcher for macOS v$VERSION${NC}"
